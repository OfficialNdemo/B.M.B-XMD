...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "B.m.b-Xmd~gK1BWDRK#K3UP1MLs5QChU0BzeuvOBsk6kKTRC_t70_ZDfDqsGc0",
// add your Session Id 
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "254741669751",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "Anonymous🕶",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ✦ B.M.B-XMD ✦ XMD ✦*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/d7o1fx.jpg",
